...
<body>
    ...
    <h3 style="text-align: center; margin-bottom: 20px;">LAPORAN PENDAFTARAN PERIODE</h3>
    
    <div style="margin-bottom: 20px;">
        <table style="border: none;">
            <tr style="border: none;">
                <td style="border: none; width: 150px;">Periode</td>
                <td style="border: none;">: {{ date('d/m/Y', strtotime($tanggalMulai)) }} s/d {{ date('d/m/Y', strtotime($tanggalAkhir)) }}</td>
            </tr>
            <tr style="border: none;">
