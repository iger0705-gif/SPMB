...
<html>
<head>
    <title>Laporan per Jurusan</title>
    <style>
...
<body>
    ...
    <h3 style="text-align: center; margin-bottom: 20px;">LAPORAN PENDAFTARAN PER JURUSAN</h3>
    
    <div style="margin-bottom: 20px;">
        <table style="border: none;">
            <tr style="border: none;">
                <td style="border: none; width: 150px;">Jurusan</td>
                <td style="border: none;">: {{ $jurusan->nama }}</td>
            </tr>
            <tr style="border: none;">
                <td style="border: none;">Kuota</td>
                <td style="border: none;">: {{ $jurusan->kuota }} siswa</td>
            </tr>
            <tr style="border: none;">
