...
<body>
    ...
    <h3 style="text-align: center; margin-bottom: 20px;">LAPORAN PENDAFTARAN BULANAN</h3>
    
    <div style="margin-bottom: 20px;">
        <table style="border: none;">
            <tr style="border: none;">
                <td style="border: none; width: 150px;">Bulan</td>
                <td style="border: none;">: {{ date('F Y', strtotime($bulan . '-01')) }}</td>
            </tr>
            <tr style="border: none;">
