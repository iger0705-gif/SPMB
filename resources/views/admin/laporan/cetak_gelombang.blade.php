...
<html>
<head>
    <title>Laporan per Gelombang</title>
    <style>
...
<body>
    ...
    <h3 style="text-align: center; margin-bottom: 20px;">LAPORAN PENDAFTARAN PER GELOMBANG</h3>
    
    <div style="margin-bottom: 20px;">
        <table style="border: none;">
            <tr style="border: none;">
                <td style="border: none; width: 150px;">Gelombang</td>
                <td style="border: none;">: {{ $gelombang->nama }}</td>
            </tr>
            @if(isset($gelombang->tanggal_mulai) && isset($gelombang->tanggal_akhir))
            <tr style="border: none;">
                <td style="border: none;">Periode</td>
                <td style="border: none;">: {{ date('d/m/Y', strtotime($gelombang->tanggal_mulai)) }} s/d {{ date('d/m/Y', strtotime($gelombang->tanggal_akhir)) }}</td>
            </tr>
            @endif
            <tr style="border: none;">
