...
<body>
            ...
            <div class="left-content">
                ...
                <ul class="feature-list">
                    <li class="feature-item">
                        ...
                        <span>Akses sesuai peran pengguna</span>
                    </li>
                    <li class="feature-item">
                        <i class="bi bi-check-circle-fill"></i>
        ...
        <div class="right-layer">
            ...
            <div class="login-card">
                ...
                <div class="role-selection">
                    ...
                    <div class="role-grid">
                        <div class="role-card" data-role="pendaftar">
                        ...
                        <div class="role-card" data-role="verifikator_adm">
                            <i class="bi bi-clipboard-check role-icon"></i>
                            Verifikator
                        </div>
                        <div class="role-card" data-role="keuangan">
                            <i class="bi bi-credit-card role-icon"></i>
                            Keuangan
                        </div>
                        <div class="role-card" data-role="kepsek">
                ...
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    <input type="hidden" name="role" id="selected-role" value="pendaftar">
    ...
    <script>
        ...
        document.querySelector('.role-card[data-role="pendaftar"]').classList.add('selected');
    </script>
</body>
</html>
